...
const bucketName = "obfuscated"; // Dapat public ang bucket na ito sa Supabase
...
// ================== RAW FILE ROUTE (redirect to Supabase) ==================
app.get('/raw/:id', (req, res) => {
    const id = req.params.id;
    // Direktang i-redirect sa Supabase public URL
    const supabasePublicUrl = `https://vwtzbbxzcokqiggkmowc.supabase.co/storage/v1/object/public/${bucketName}/${id}.lua`;
    res.redirect(302, supabasePublicUrl);
});

// ================== OBFS API (direct code, may recaptcha) ==================
...
// ================== SHARE API (upload sa Supabase at balik loader URL) ==================
app.post('/api/share', async (req, res) => {
    ...
    try {
        ...
        // Bumuo ng loader URL na gagamit ng sariling domain
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .obfuscate-btn:hover, .clear-btn:hover, .sample-btn:hover, .share-btn:hover {
            transform: translateY(-2px);
...
<body>
    ...
    <div class="main-container">
        <h1>Sttar Obfuscator</h1>
        <p class="subtitle">Paste your Lua code below and get obfuscated output instantly. Share it with one click.</p>
    ...
    <script>
        ...
        let lastObfuscatedCode = ''; // I-store dito ang result para sa Share
...
print(add(5, 7))\`;
            ...
            grecaptcha.ready(() => {
                grecaptcha.execute('${RECAPTCHA_SITE_KEY}', { action: 'obfuscate' }).then(async (token) => {
                    ...
                    try {
                        ...
                        lastObfuscatedCode = obfuscated; // store for sharing
        ...
        // Share button – upload the current obfuscated code to Supabase and get loader
        shareBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                const data = await response.json();
                // Copy the loader script to clipboard
...
<body>
    ...
    <div class="main-content">
        ...
        <div id="usage" class="content-panel">
            ...
            <p><strong>New:</strong> Click SHARE to get a loadstring-ready link for Roblox executors.</p>
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <p>Obfuscate Lua code. Requires reCAPTCHA token.</p>
            <div class="code-block">{ "code": "...", "recaptchaToken": "..." }</div>
            <p>Returns plain text obfuscated code.</p>
        </div>
        <div class="card">
            <h2>POST /api/share</h2>
            <p>Upload already obfuscated code and get a loadstring-ready share link.</p>
            <div class="code-block">{ "code": "obfuscated code..." }</div>
            <p>Returns { "loaderUrl": "...", "loaderScript": "..." }</p>
        </div>
        <div class="note">
